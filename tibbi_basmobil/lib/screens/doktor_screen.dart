...
class DoktorScreen extends StatefulWidget {
  const DoktorScreen({super.key});

  @override
  State<DoktorScreen> createState() => _DoktorEkranState();
}

class _DoktorEkranState extends State<DoktorScreen> {
            ...
            children: [
              ...
              InkWell(
                child: Container(
                  ...
                  child: const Text(
                    'Son İletilen Baş Ağrısı Bildirimleri',
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    'Hasta: ${snapshot.data?[index].username}',
                                    style: const TextStyle(
                                        fontSize: 16,
                                ...
                                Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        snapshot.data?[index].belirti != ""
                                            ? Text(
                                                "${snapshot.data?[index].detay == '' ? 'Yok' : snapshot.data?[index].detay}",
                                                style: const TextStyle(
                                                  fontSize: 16,
                                                  color: Colors.black,
                                                ))
